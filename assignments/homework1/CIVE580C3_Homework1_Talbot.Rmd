...
watersheds = gpd.read_file("../remote-sensing-hydro-2025/data/watersheds/huc2.shp")
watershed_16 = watersheds[watersheds['REG'] == '16'].to_crs(output_crs)

# List all PRISM raster files
prism_files = [
    os.path.join("../remote-sensing-hydro-2025/data/prism", f)
    for f in os.listdir("../remote-sensing-hydro-2025/data/prism")
    if f.endswith("bil")
]
